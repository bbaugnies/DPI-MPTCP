...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__broccoli_intern
...
SWIGINTERN PyObject *_wrap_bro_conn_alive(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  res1 = SWIG_ConvertPtr(obj0,SWIG_as_voidptrptr(&arg1), 0, 0);
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "bro_conn_alive" "', argument " "1"" of type '" "BroConn *""'"); 
  }
  result = (int)bro_conn_alive(arg1);
  resultobj = SWIG_From_int((int)(result));
  return resultobj;
fail:
  return NULL;
...
static swig_type_info _swigt__p_void = {"_p_void", "BroEvent *|void *|BroCtx *|BroConn *", 0, 0, (void*)0, 0};
...
# endif
  ...
  SWIG_Python_SetConstant(d, "BRO_TYPE_SUBNET",SWIG_From_int((int)(14)));
  SWIG_Python_SetConstant(d, "BRO_TYPE_ANY",SWIG_From_int((int)(15)));
  SWIG_Python_SetConstant(d, "BRO_TYPE_TABLE",SWIG_From_int((int)(16)));
  SWIG_Python_SetConstant(d, "BRO_TYPE_UNION",SWIG_From_int((int)(17)));
  SWIG_Python_SetConstant(d, "BRO_TYPE_RECORD",SWIG_From_int((int)(18)));
  SWIG_Python_SetConstant(d, "BRO_TYPE_LIST",SWIG_From_int((int)(19)));
  SWIG_Python_SetConstant(d, "BRO_TYPE_FUNC",SWIG_From_int((int)(20)));
  SWIG_Python_SetConstant(d, "BRO_TYPE_FILE",SWIG_From_int((int)(21)));
  SWIG_Python_SetConstant(d, "BRO_TYPE_VECTOR",SWIG_From_int((int)(22)));
  SWIG_Python_SetConstant(d, "BRO_TYPE_ERROR",SWIG_From_int((int)(23)));
  SWIG_Python_SetConstant(d, "BRO_TYPE_PACKET",SWIG_From_int((int)(24)));
  SWIG_Python_SetConstant(d, "BRO_TYPE_SET",SWIG_From_int((int)(25)));
  SWIG_Python_SetConstant(d, "BRO_TYPE_MAX",SWIG_From_int((int)(26)));
