...
#line 151 "functions.bif"
Val* BifFunc::bro_x509_parse(Frame* frame, val_list* BiF_ARGS)
	
#line 152 "functions.bif"
{
	if ( BiF_ARGS->length() != 1 )
		{
		reporter->Error("x509_parse() takes exactly 1 argument(s)");
		return 0;
		}
	Val* cert = (Val*) ((*BiF_ARGS)[0]);
...
#line 152 "functions.bif"
	...
	} // end of BifFunc::bro_x509_parse

#line 157 "functions.bif"

#line 171 "functions.bif"
Val* BifFunc::bro_x509_get_certificate_string(Frame* frame, val_list* BiF_ARGS)
	
#line 172 "functions.bif"
{
	if ( BiF_ARGS->length() != 2 )
		{
		reporter->Error("x509_get_certificate_string() takes exactly 2 argument(s)");
		return 0;
		}
	Val* cert = (Val*) ((*BiF_ARGS)[0]);
	int pem = (int) ((*BiF_ARGS)[1]->AsBool());
...
#line 172 "functions.bif"
	...
	return ext_val;
	} // end of BifFunc::bro_x509_get_certificate_string

#line 190 "functions.bif"

#line 208 "functions.bif"
Val* BifFunc::bro_x509_ocsp_verify(Frame* frame, val_list* BiF_ARGS)
	
#line 209 "functions.bif"
{
	if ( BiF_ARGS->length() != 4 )
		{
		reporter->Error("x509_ocsp_verify() takes exactly 4 argument(s)");
		return 0;
		}
	Val* certs = (Val*) ((*BiF_ARGS)[0]);
	StringVal* ocsp_reply = (StringVal*) ((*BiF_ARGS)[1]->AsStringVal());
	Val* root_certs = (Val*) ((*BiF_ARGS)[2]);
	double verify_time = (double) ((*BiF_ARGS)[3]->AsTime());
...
x509_ocsp_cleanup:
	...
	return rval;
	} // end of BifFunc::bro_x509_ocsp_verify

#line 434 "functions.bif"

#line 453 "functions.bif"
Val* BifFunc::bro_x509_verify(Frame* frame, val_list* BiF_ARGS)
	
#line 454 "functions.bif"
{
	if ( BiF_ARGS->length() != 3 )
		{
		reporter->Error("x509_verify() takes exactly 3 argument(s)");
		return 0;
		}
	Val* certs = (Val*) ((*BiF_ARGS)[0]);
	Val* root_certs = (Val*) ((*BiF_ARGS)[1]);
	double verify_time = (double) ((*BiF_ARGS)[2]->AsTime());
...
x509_verify_chainerror:
	...
	return rrecord;
	} // end of BifFunc::bro_x509_verify

#line 538 "functions.bif"
