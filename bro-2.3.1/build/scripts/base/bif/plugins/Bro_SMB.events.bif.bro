...
export {
global smb_message: event(c: connection , hdr: smb_hdr , is_orig: bool , cmd: string , body_length: count , body: string );
...
##    been ported to Bro 2.x. To still enable this event, one needs to
##    register a port for it or add a DPD payload signature.
global smb_com_tree_connect_andx: event(c: connection , hdr: smb_hdr , path: string , service: string );
...
##    been ported to Bro 2.x. To still enable this event, one needs to
##    register a port for it or add a DPD payload signature.
global smb_com_tree_disconnect: event(c: connection , hdr: smb_hdr );
...
##    been ported to Bro 2.x. To still enable this event, one needs to
##    register a port for it or add a DPD payload signature.
global smb_com_nt_create_andx: event(c: connection , hdr: smb_hdr , name: string );
...
##    been ported to Bro 2.x. To still enable this event, one needs to
##    register a port for it or add a DPD payload signature.
global smb_com_transaction: event(c: connection , hdr: smb_hdr , trans: smb_trans , data: smb_trans_data , is_orig: bool );
...
##    been ported to Bro 2.x. To still enable this event, one needs to
##    register a port for it or add a DPD payload signature.
global smb_com_transaction2: event(c: connection , hdr: smb_hdr , trans: smb_trans , data: smb_trans_data , is_orig: bool );
...
##    been ported to Bro 2.x. To still enable this event, one needs to
##    register a port for it or add a DPD payload signature.
global smb_com_trans_mailslot: event(c: connection , hdr: smb_hdr , trans: smb_trans , data: smb_trans_data , is_orig: bool );
...
##    been ported to Bro 2.x. To still enable this event, one needs to
##    register a port for it or add a DPD payload signature.
global smb_com_trans_rap: event(c: connection , hdr: smb_hdr , trans: smb_trans , data: smb_trans_data , is_orig: bool );
...
##    been ported to Bro 2.x. To still enable this event, one needs to
##    register a port for it or add a DPD payload signature.
global smb_com_trans_pipe: event(c: connection , hdr: smb_hdr , trans: smb_trans , data: smb_trans_data , is_orig: bool );
...
##    been ported to Bro 2.x. To still enable this event, one needs to
##    register a port for it or add a DPD payload signature.
global smb_com_read_andx: event(c: connection , hdr: smb_hdr , data: string );
...
##    been ported to Bro 2.x. To still enable this event, one needs to
##    register a port for it or add a DPD payload signature.
global smb_com_write_andx: event(c: connection , hdr: smb_hdr , data: string );
...
##    been ported to Bro 2.x. To still enable this event, one needs to
##    register a port for it or add a DPD payload signature.
global smb_get_dfs_referral: event(c: connection , hdr: smb_hdr , max_referral_level: count , file_name: string );
...
##    been ported to Bro 2.x. To still enable this event, one needs to
##    register a port for it or add a DPD payload signature.
global smb_com_negotiate: event(c: connection , hdr: smb_hdr );
...
##    been ported to Bro 2.x. To still enable this event, one needs to
##    register a port for it or add a DPD payload signature.
global smb_com_negotiate_response: event(c: connection , hdr: smb_hdr , dialect_index: count );
...
##    been ported to Bro 2.x. To still enable this event, one needs to
##    register a port for it or add a DPD payload signature.
global smb_com_setup_andx: event(c: connection , hdr: smb_hdr );
...
##    been ported to Bro 2.x. To still enable this event, one needs to
##    register a port for it or add a DPD payload signature.
global smb_com_generic_andx: event(c: connection , hdr: smb_hdr );
...
##    been ported to Bro 2.x. To still enable this event, one needs to
##    register a port for it or add a DPD payload signature.
global smb_com_close: event(c: connection , hdr: smb_hdr );
...
##    been ported to Bro 2.x. To still enable this event, one needs to
##    register a port for it or add a DPD payload signature.
global smb_com_logoff_andx: event(c: connection , hdr: smb_hdr );
...
##    been ported to Bro 2.x. To still enable this event, one needs to
##    register a port for it or add a DPD payload signature.
global smb_error: event(c: connection , hdr: smb_hdr , cmd: count , cmd_str: string , data: string );
