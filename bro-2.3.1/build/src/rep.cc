...
#line 34 "re-parse.y" /* yacc.c:1646  */
    { (yyvsp[0].mach_val)->AddAccept(1); nfa = (yyvsp[0].mach_val); }
...
#line 109 "re-parse.y" /* yacc.c:1646  */
    {
			(yyval.mach_val) = new NFA_Machine(new NFA_State(rem->AnyCCL()));
			}
...
#line 114 "re-parse.y" /* yacc.c:1646  */
    {
			...
			rem->EC()->CCL_Use((yyvsp[0].ccl_val));
			(yyval.mach_val) = new NFA_Machine(new NFA_State((yyvsp[0].ccl_val)));
			}
...
#line 130 "re-parse.y" /* yacc.c:1646  */
    {
			if ( case_insensitive && (yyvsp[0].int_val) >= 'A' && (yyvsp[0].int_val) <= 'Z' )
				(yyvsp[0].int_val) = clower((yyvsp[0].int_val));
			(yyval.mach_val) = new NFA_Machine(new NFA_State((yyvsp[0].int_val), rem->EC()));
			}
...
#line 137 "re-parse.y" /* yacc.c:1646  */
    {
			(yyval.mach_val) = new NFA_Machine(new NFA_State(SYM_BOL, rem->EC()));
...
#line 143 "re-parse.y" /* yacc.c:1646  */
    {
			(yyval.mach_val) = new NFA_Machine(new NFA_State(SYM_EOL, rem->EC()));
...
#line 160 "re-parse.y" /* yacc.c:1646  */
    {
			if ( case_insensitive )
				{
				if ( (yyvsp[-2].int_val) >= 'A' && (yyvsp[-2].int_val) <= 'Z' )
					(yyvsp[-2].int_val) = clower((yyvsp[-2].int_val));
				if ( (yyvsp[0].int_val) >= 'A' && (yyvsp[0].int_val) <= 'Z' )
					(yyvsp[0].int_val) = clower((yyvsp[0].int_val));
				}
...
#line 202 "re-parse.y" /* yacc.c:1646  */
    {
			...
			(yyvsp[-1].mach_val)->AppendState(new NFA_State((yyvsp[0].int_val), rem->EC()));
			}
