...
export {
global ssl_client_hello: event(c: connection , version: count , possible_ts: time , client_random: string , session_id: string , ciphers: index_vec );
...
global ssl_server_hello: event(c: connection , version: count , possible_ts: time , server_random: string , session_id: string , cipher: count , comp_method: count );
...
global ssl_extension: event(c: connection , is_orig: bool , code: count , val: string );
...
global ssl_extension_elliptic_curves: event(c: connection , is_orig: bool , curves: index_vec );
...
##    ssl_extension_elliptic_curves ssl_extension_application_layer_protocol_negotiation
##    ssl_extension_server_name ssl_server_curve
global ssl_extension_ec_point_formats: event(c: connection , is_orig: bool , point_formats: index_vec );
...
##    ssl_extension_elliptic_curves ssl_extension_application_layer_protocol_negotiation
##    ssl_extension_server_name
global ssl_server_curve: event(c: connection , curve: count );
...
##    ssl_extension_server_name
global ssl_extension_application_layer_protocol_negotiation: event(c: connection , is_orig: bool , protocols: string_vec );
...
global ssl_extension_server_name: event(c: connection , is_orig: bool , names: string_vec );
...
global ssl_alert: event(c: connection , is_orig: bool , level: count , desc: count );
...
global ssl_heartbeat: event(c: connection , is_orig: bool , length: count , heartbeat_type: count , payload_length: count , payload: string );
...
global ssl_encrypted_data: event(c: connection , is_orig: bool , content_type: count , length: count );
...
##
## response: OCSP data.
global ssl_stapled_ocsp: event(c: connection , is_orig: bool , response: string );
...
##    ssl_change_cipher_spec
global ssl_handshake_message: event(c: connection , is_orig: bool , msg_type: count , length: count );
...
global ssl_change_cipher_spec: event(c: connection , is_orig: bool );
